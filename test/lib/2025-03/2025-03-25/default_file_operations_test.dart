...
import 'package:modu_3_dart_study/2025-03/2025-03-25/default_file_operations.dart';
import 'package:modu_3_dart_study/2025-03/2025-03-25/file_operations.dart';
...
void main() {
  ...
  test('원본 경로의 파일을 목표 경로에 정확히 복사해야한다.', () {
    // GIVEN
    const String originPath = 'playground/2025-03/2025-03-25/my_file.txt';
    const String targetPath = 'test/lib/2025-03/2025-03-25/test.txt';
