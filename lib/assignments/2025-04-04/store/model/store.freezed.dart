...
mixin _$Store {
 ...
 String get address; String get code; DateTime get createdAt; double get lat; double get lng; String get name; String get remainStat; DateTime get stockAt; String get type;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,address,code,createdAt,lat,lng,name,remainStat,stockAt,type);
...
@useResult
$Res call({
 String address, String code, DateTime createdAt, double lat, double lng, String name, String remainStat, DateTime stockAt, String type
});
...
/// Create a copy of Store
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? address = null,Object? code = null,Object? createdAt = null,Object? lat = null,Object? lng = null,Object? name = null,Object? remainStat = null,Object? stockAt = null,Object? type = null,}) {
...
class _Store implements Store {
  const _Store({required this.address, required this.code, required this.createdAt, required this.lat, required this.lng, required this.name, required this.remainStat, required this.stockAt, required this.type});
...
/// Create a copy of Store
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? address = null,Object? code = null,Object? createdAt = null,Object? lat = null,Object? lng = null,Object? name = null,Object? remainStat = null,Object? stockAt = null,Object? type = null,}) {
  return _then(_Store(
address: null == address ? _self.address : address // ignore: cast_nullable_to_non_nullable
as String,code: null == code ? _self.code : code // ignore: cast_nullable_to_non_nullable
as String,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
