...
mixin _$StoreDto {
 ...
 String? get addr; String? get code;@JsonKey(name: "created_at") String? get createdAt; num? get lat; num? get lng; String? get name;@JsonKey(name: "remain_stat") String? get remainStat;@JsonKey(name: "stock_at") String? get stockAt; String? get type;
...
@useResult
$Res call({
 String? addr, String? code,@JsonKey(name: "created_at") String? createdAt, num? lat, num? lng, String? name,@JsonKey(name: "remain_stat") String? remainStat,@JsonKey(name: "stock_at") String? stockAt, String? type
});
...
class _StoreDto implements StoreDto {
  const _StoreDto({this.addr, this.code, @JsonKey(name: "created_at") this.createdAt, this.lat, this.lng, this.name, @JsonKey(name: "remain_stat") this.remainStat, @JsonKey(name: "stock_at") this.stockAt, this.type});
