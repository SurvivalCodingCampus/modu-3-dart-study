...
mixin _$PhotoDto {
 ...
 Object get id; String? get type; String? get title; String? get content; String? get url; String? get caption;@JsonKey(name: 'created_at') String? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(id),type,title,content,url,caption,createdAt);

@override
String toString() {
  return 'PhotoDto(id: $id, type: $type, title: $title, content: $content, url: $url, caption: $caption, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 Object id, String? type, String? title, String? content, String? url, String? caption,@JsonKey(name: 'created_at') String? createdAt
});
...
/// Create a copy of PhotoDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = freezed,Object? title = freezed,Object? content = freezed,Object? url = freezed,Object? caption = freezed,Object? createdAt = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id ,type: freezed == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
...
class _PhotoDto implements PhotoDto {
  const _PhotoDto({required this.id, this.type = 'unknown', this.title = '', this.content = '', this.url = '', this.caption = '', @JsonKey(name: 'created_at') this.createdAt = '1999-01-01'});
...
/// Create a copy of PhotoDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = freezed,Object? title = freezed,Object? content = freezed,Object? url = freezed,Object? caption = freezed,Object? createdAt = freezed,}) {
